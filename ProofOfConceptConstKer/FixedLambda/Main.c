...
///////////////
// Solve using the given value of lambda. First solve the problem in standard form:
...
struct bspline_comb_params params_linearcomb 
			={kernel_expansion_coefs,bw,B,NCOEFFS};
